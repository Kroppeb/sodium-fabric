...
public class ChunkRenderManager implements ChunkStatusListener {
    ...
    private void loadChunk(int x, int z) {
        ChunkRenderColumn column = new ChunkRenderColumn(x, z, this.world.countVerticalSections());
    ...
    private void unloadSections(ChunkRenderColumn column) {
        for (int y = this.world.getBottomSectionCoord(); y < this.world.getTopSectionCoord(); y++) {
            ChunkRenderContainer render = column.getRender(this.world.sectionCoordToIndex(y));
